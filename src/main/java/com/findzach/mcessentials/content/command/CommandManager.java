...
public class CommandManager {
    ...
    public CommandManager() {
        ...
        Reflections reflections = new Reflections("com.findzach.mcessentials.content.command.impl");
        Reflections featureReflection = new Reflections("com.findzach.mcessentials.content.feature.impl");
