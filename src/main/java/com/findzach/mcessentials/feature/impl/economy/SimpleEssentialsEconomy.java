 ...
 * @since 9/10/2023
 */
public class SimpleEssentialsEconomy implements Economy {

    private EconomyManager economyManager = (EconomyManager) MCEssentials.getInstance().getFeatureManager().getFeature(FeatureType.ECONOMY);
